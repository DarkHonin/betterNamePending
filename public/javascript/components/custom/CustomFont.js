...
var CustomFont = function (_Custom) {
    _inherits(CustomFont, _Custom);
    ...
    _createClass(CustomFont, [{
        ...
        value: function componentDidMount() {
            ...
            var getFontThings = function () {
                var font_options = _this3.child.fonts.map(function (value, index) {
                    return React.createElement(
                        'option',
                ...
                var font_refrence = _this3.child.fonts.map(function (v) {
                    return v;
                });
